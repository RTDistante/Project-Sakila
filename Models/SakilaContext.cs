        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Actor>(entity =>
            {
                entity.HasKey(e => e.ActorId)
                    .HasName("PK__actor__8B2447B5528DFA2F")
                    .IsClustered(false);
            ...
            modelBuilder.Entity<ActorDramas>(entity =>
            {
                ...
                entity.Property(e => e.TotalDramas).HasColumnName("Total Dramas");
            });

            modelBuilder.Entity<Address>(entity =>
            {
                entity.HasKey(e => e.AddressId)
                    .HasName("PK__address__CAA247C9CD898215")
                    .IsClustered(false);
            ...
            modelBuilder.Entity<Category>(entity =>
            {
                entity.HasKey(e => e.CategoryId)
                    .HasName("PK__category__D54EE9B538D04687")
                    .IsClustered(false);
            ...
            modelBuilder.Entity<City>(entity =>
            {
                entity.HasKey(e => e.CityId)
                    .HasName("PK__city__031491A906559ADD")
                    .IsClustered(false);
            ...
            modelBuilder.Entity<Country>(entity =>
            {
                entity.HasKey(e => e.CountryId)
                    .HasName("PK__country__7E8CD05413BE4F45")
                    .IsClustered(false);
            ...
            modelBuilder.Entity<Customer>(entity =>
            {
                entity.HasKey(e => e.CustomerId)
                    .HasName("PK__customer__CD65CB84ED16AD8B")
                    .IsClustered(false);
            ...
            modelBuilder.Entity<Film>(entity =>
            {
                entity.HasKey(e => e.FilmId)
                    .HasName("PK__film__349764A86440BEC1")
                    .IsClustered(false);
            ...
            modelBuilder.Entity<FilmActor>(entity =>
            {
                entity.HasKey(e => new { e.ActorId, e.FilmId })
                    .HasName("PK__film_act__086D31FF1C902106")
                    .IsClustered(false);
            ...
            modelBuilder.Entity<FilmCategory>(entity =>
            {
                entity.HasKey(e => new { e.FilmId, e.CategoryId })
                    .HasName("PK__film_cat__69C38A33B0D0E0BB")
                    .IsClustered(false);
            ...
            {
                entity.HasKey(e => e.FilmId)
                    .HasName("PK__film_tex__349764A8B4419620")
                    .IsClustered(false);
            ...
            modelBuilder.Entity<Inventory>(entity =>
            {
                entity.HasKey(e => e.InventoryId)
                    .HasName("PK__inventor__B59ACC48A38F1898")
                    .IsClustered(false);
            ...
            modelBuilder.Entity<Language>(entity =>
            {
                entity.HasKey(e => e.LanguageId)
                    .HasName("PK__language__804CF6B2F355FBD5")
                    .IsClustered(false);
            ...
            modelBuilder.Entity<Payment>(entity =>
            {
                entity.HasKey(e => e.PaymentId)
                    .HasName("PK__payment__ED1FC9EB837944EF")
                    .IsClustered(false);
            ...
            modelBuilder.Entity<Rental>(entity =>
            {
                entity.HasKey(e => e.RentalId)
                    .HasName("PK__rental__67DB611A2295F756")
                    .IsClustered(false);
            ...
            modelBuilder.Entity<RentalsByActor>(entity =>
            {
                ...
                entity.Property(e => e.TotalRentals).HasColumnName("Total Rentals");
            });
            ...
            modelBuilder.Entity<Staff>(entity =>
            {
                entity.HasKey(e => e.StaffId)
                    .HasName("PK__staff__1963DD9D48B5DA81")
                    .IsClustered(false);
            ...
            modelBuilder.Entity<Store>(entity =>
            {
                entity.HasKey(e => e.StoreId)
                    .HasName("PK__store__A2F2A30DC23D9F28")
                    .IsClustered(false);
